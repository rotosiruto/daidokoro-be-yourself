...
<body>
          ...
          <div class="nav-collapse">
            <ul class="nav">
              ...
              <li class="<?php if ($this->name == 'Users' && $this->action == 'mypage') {
               echo 'active';}?>"><a href="">マイページへ</a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="container">
    <?php print(h($userRegistration['mail_address'])); ?>さんのマイページです。<br />
<?php print($this->Html->link('ログアウト', '../user_registrations/logout')); ?>
<section>
<div class="btn-group">
                                    <div class="btn btn-primary dropdown-toggle" data-toggle="dropdown">カセットの編集<span class="caret"></span></div>
                                    <ul class="dropdown-menu">
                                        <li><div class="js-modal-cassette-add" id="js-modal-cassette-add">追加</div></li>
                                        <li><a href="bootstrap.html#">削除</a></li>
                                        <li><a href="bootstrap.html#">一括削除</a></li>
                                        <li><a href="bootstrap.html#">一括更新</a></li>
                                    </ul>
                                </div>
</section>
    ...
    vertical-align:top
            ...
            <script type="text/javascript" charset="utf-8">
              $(document).ready(function() {
                $('#js-modal-cassette-add').click(function(){
                  $('#js-modal-overlay, #js-modal-contentXls').fadeIn('fast');
                });
